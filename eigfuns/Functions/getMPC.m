...
switch lower(solver)
    ...
    case 'quadprog'
        disp('Building controller with quadprog. This solver is slow. Use qpOASES for faster closed-loop simulation.')
        MPC_ctr = @(x00,yrr)(mpcController_quadprog(x00,yrr, H,Aineq,N,Ab,Xlb,Xub,M1,M2,ulin,d,Ulb,Uub,p,C,Q));
...
function [U,optval,flag] = mpcController_quadprog(x0,yr,H,Aineq,N,Ab,Xlb,Xub,M1,M2,ulin,d,Ulb,Uub,p,C,Q)
% INPUTS: x0, yr
...
[U,optval,flag] = quadprog((H+H')/2, f, Aineq, bineq,[],[],Ulb,Uub);
