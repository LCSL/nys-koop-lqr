...
for seed = (0:49)
    ...
    pyrun("spec = importlib.util.spec_from_file_location('regressors', '/Users/edoardocaldarelli/Documents/phd/koopman_mpc/regressors.py')")
    ...
    for kapprox = ["nystrom", "splines"]
        ref = pyrun("res = np.loadtxt(f'/Users/edoardocaldarelli/Documents/phd/koopman_mpc/8x8_cloth_swing_xyz/sim_results/{arg1}/data/reference_lqr.csv').reshape([-1, 1])", "res", arg1=kapprox);
        tic
        % TODO careful with ordering of the nodes!!!!!!!!!!
        K_lqr = pyrun("res = np.loadtxt(f'/Users/edoardocaldarelli/Documents/phd/koopman_mpc/8x8_cloth_swing_xyz/sim_results/{arg1}/data/K_lqr_seed_" + seed + ".csv')", "res", arg1=kapprox);
        fid = py.open("/Users/edoardocaldarelli/Documents/phd/koopman_mpc/8x8_cloth_swing_xyz/sim_results/" + kapprox + "/data/regressor_seed_" + seed + ".npy", 'rb');
        regressor = py.pickle.load(fid);
        lifted_ref = pyrun("res = arg1.lift(arg2)", "res", arg1=regressor, arg2=ref);
        phi0_reshaped = reshape(phi0', n_nodos * 3, 1);
        ...
        for tt=1:(tf-1)  
            ...
            curr_rmse = sqrt(sum(array(pyrun("res = (arg2 - regr.C @ arg3)", "res", arg2=ref, arg3=lifted_state, regr=regressor)).^2))
            if kapprox == "nystrom"
                rmses_nys = [rmses_nys, curr_rmse];
            else
                rmses_splines = [rmses_splines, curr_rmse];
            end
            delta_u = array(pyrun("res = arg1 @ (arg2 - arg3)", "res", arg1=K_lqr, arg2=lifted_ref, arg3=lifted_state));
    ...
    writematrix(rmses_nys, "/Users/edoardocaldarelli/Documents/phd/koopman_mpc/8x8_cloth_swing_xyz/sim_results/rmse_nys_seed_" + seed + ".csv")
    writematrix(rmses_splines, "/Users/edoardocaldarelli/Documents/phd/koopman_mpc/8x8_cloth_swing_xyz/sim_results/rmse_splines_seed_" + seed + ".csv")
end